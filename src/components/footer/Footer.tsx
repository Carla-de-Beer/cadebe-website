...
function FooterBadges() {
  ...
  if (layout === 'mobile') {
    return (
      <div>
        <Badge bg="secondary" pill>Software Engineering</Badge>
        <br />
        <Badge bg="secondary" pill>Cloud</Badge>
        <br />
        <Badge bg="secondary" pill>Backend Development</Badge>
        <br />
        <Badge bg="secondary" pill>Machine Learning</Badge>
      </div>
    );
  }
  return (
    <div>
      <Badge bg="secondary" pill>Software Engineering</Badge>
      <Badge bg="secondary" pill className="ms-2">Backend Development</Badge>
      <Badge bg="secondary" pill className="ms-2">Cloud</Badge>
      <Badge bg="secondary" pill className="ms-2">Machine Learning</Badge>
    </div>
  );
}
    ...
    <div className="footer-wrapper">
      <div className="footer-style mt-5">
        ...
        <div className="text-fields mt-5">
          ...
          <a className="ms-2" href="https://www.linkedin.com/in/carla-de-beer/" target="_blank" rel="noopener noreferrer">
            <img src={linkedIn} width="25px" height="25px" alt="Icon" />
          </a>
          <a className="ms-2" href="https://github.com/Carla-de-Beer" target="_blank" rel="noopener noreferrer">
